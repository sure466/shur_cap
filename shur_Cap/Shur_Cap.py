...
init()
print(Fore.RED + pyfiglet.figlet_format("Shur_Cap"))
created_by = '''Shurvesh''' 
banner = pyfiglet.figlet_format(created_by, font='small')
print (Fore.GREEN + "Created By:\n", created_by + '\nhttps://www.github.com/sure466/Shur_Cap')
...
file.write(f'\n\n\t\t#Generated By Recon_CAP\n#https://github.com/sure466/Shur_Cap\nResult Generated at {x.strftime("%X %x")}\n\nAccounts Found\n\n')
file.close()
print('\n')
